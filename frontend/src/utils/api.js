...
const api = {
  ...
  getUniqueDiveGuides: () =>
    makeApiRequest('get', API_ENDPOINTS.getUniqueDiveGuides),

  getFilteredDives: (filters, page, entriesPerPage) =>
    makeApiRequest('get', API_ENDPOINTS.getFilteredDives, null, {
      ...filters,
      page,
      entriesPerPage
    }),
